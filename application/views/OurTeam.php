  ...
  <body>
      ...
      <div class="container">
        <div class="row py-5">
          <div class="col-md-12 text-white">
            <h3 class="text-center m-4">"Kebersamaan adalah permulaan. Menjaga bersama adalah kemajuan. Bekerja bersama adalah keberhasilan.-Henry Ford-</h3>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          <div class="card mt-2">
            ...
            <div class="card-body">
              ...
              <br>27 Januari 1998
              <p class="card-text">Jurusan Teknik Informatika angkatan 2016 Institut Teknologi Sumatera.</p>
        ...
        <div class="col-md-3">
          <div class="card mt-2">
            <img class="card-img-top" src="<?php echo base_url(); ?>/assets/images/nama_oktri.png" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Muhammad Oktri S.</h5>
              <br>08 Oktober 1997
              <p class="card-text">Jurusan Teknik Informatika angkatan 2016 Institut Teknologi Sumatera.</p>
            </div>
          </div>
        ...
        <div class="col-md-3">
          <div class="card mt-2">
            <img class="card-img-top" src="<?php echo base_url(); ?>/assets/images/nama_peik.png" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Muhammad Syafi'i</h5>
              <br>29 Desember 1997
              <p class="card-text">Jurusan Teknik Informatika angkatan 2016 Institut Teknologi Sumatera.</p>
        ...
        <div class="col-md-3">
          <div class="card mt-2">
            <img class="card-img-top" src="<?php echo base_url(); ?>/assets/images/nama_agus.png" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Agustino Rahmawan</h5>
              <br>08 Agustus 1998
              <p class="card-text">Jurusan Teknik Informatika angkatan 2016 Institut Teknologi Sumatera.</p>
        ...
        <div class="col-md-3">
          <div class="card mt-2">
            <img class="card-img-top" src="<?php echo base_url(); ?>/assets/images/nama_vicko.png" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Vicko Pratama</h5>
              <br>21 Oktober 1998
              <p class="card-text">Jurusan Teknik Informatika angkatan 2016 Institut Teknologi Sumatera.</p>
