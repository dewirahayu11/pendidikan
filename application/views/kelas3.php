        ...
        <div class="col-md-12">
          ...
          <main role="main">
            <section class="jumbotron text-center">
              <div class="container">
                <h1 class="jumbotron-heading">Kelas 3</h1>
                <p class="lead text-muted">Pada tingkat Kelas 3, Materi yang dapat diakses meliputi Matematika, Bahasa Indonesia, Agama Islam, Penjaskes, serta video-video pelajaran setiap materi.</p>
              </div>
            </section>
           </main>
           <div class="row">
               ...
               <div class="accordion" id="accordionExample">
                  <div class="card">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                      <div class="card-body">
                        <button type="button" class="btn btn-outline-secondary"><a href="<?php echo base_url(); ?>/assets/documents/kelas3/Kelas 3 Agama.pdf">Agama Islam</a></button>
                        <button type="button" class="btn btn-outline-secondary"><a href="<?php echo base_url(); ?>/assets/documents/kelas3/Kelas 3 Bahasa Indonesia.pdf">Bahasa Indonesia</a></button>
                        <button type="button" class="btn btn-outline-secondary"><a href="<?php echo base_url(); ?>/assets/documents/kelas3/Kelas 3 Matematika.pdf">Matematika</a></button>
                        <button type="button" class="btn btn-outline-secondary"><a href="<?php echo base_url(); ?>/assets/documents/kelas3/Kelas 3 Olahraga.pdf">Penjaskes</a></button>
                      </div>
                    </div>
                  </div>
                  <div class="card">
