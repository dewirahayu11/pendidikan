            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light" id="mainNav">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="OurFitur">Our Product</a></li>
      ...
      <div class="container">
        <<div class="row py-5">
          <div class="col-md-12 py-5">
           <h3 class="text-center m-2"><br> KELAS 6 </br> <br></br>"Pada tingkat Kelas 4, Materi yang dapat diakses meliputi Matematika, Bahasa Indonesia, Ilmu Pengetahuan Alam, Agama Islam, serta video-video pelajaran setiap materi.</h3>
         </div>
        </div>
      </div>
    </div>
               ...
               <div class="accordion" id="accordionExample">
                  <div class="card">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                      <div class="card-body">
                        <button type="button" class="btn btn-outline-secondary"><a href="<?php echo base_url(); ?>/assets/documents/kelas6/agama/Asmaul.pdf">Agama</a></button>
                        <button type="button" class="btn btn-outline-secondary"><a href="<?php echo base_url(); ?>/assets/documents/kelas6/B.Indo/Fiksi.pdf">Bahasa Indonesia</a></button>
                        <button type="button" class="btn btn-outline-secondary"><a href="<?php echo base_url(); ?>/assets/documents/kelas6/Inggris/cakap.pdf">Bahasa Inggis</a></button>
                        <button type="button" class="btn btn-outline-secondary"><a href="<?php echo base_url(); ?>/assets/documents/kelas6/IPA/kembangbiak.pdf">IPA</a></button>
                        <button type="button" class="btn btn-outline-secondary"><a href="<?php echo base_url(); ?>/assets/documents/kelas6/MTK/bulat.doc">Matematika</a></button>
                      </div>
                    </div>
                  </div>
                  <div class="card">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                      <div class="card-body">
                        <button type="button" class="btn btn-outline-secondary video-btn" data-toggle="model"><a href="<?php echo base_url(); ?>/assets/videos/kelas6/bulat.MP4">Matematika</a></button>
                        <button type="button" class="btn btn-outline-secondary video-btn" data-toggle="model"><a href="<?php echo base_url(); ?>/assets/videos/kelas6/Nabi.MP4">Agama Islam</a></button>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-md-5">
            <div class="row">
              <div class="col-md-6">
                ...
                <ul class="list-group">
                  <li class="list-group-item"><a href="about">Tentan Kami</a></li>
