        ...
        <div class="col-md-12">
          ...
          <main role="main">
            <section class="jumbotron text-center">
              <div class="container">
                <h1 class="jumbotron-heading">Kelas 6</h1>
                <p class="lead text-muted">Pada tingkat Kelas 6, Materi yang dapat diakses meliputi Matematika, Bahasa Indonesia, Agama Islam, Ilmu Pengetahuan Alam, serta video-video pelajaran setiap materi..</p>
              </div>
            </section>
           </main>
           <div class="row">
               ...
               <div class="accordion" id="accordionExample">
                  <div class="card">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                      <div class="card-body">
                        <button type="button" class="btn btn-outline-secondary"><a href="<?php echo base_url(); ?>/assets/documents/kelas6/Agama/Asmaul.pdf">Agama Islam</a></button>
                        <button type="button" class="btn btn-outline-secondary"><a href="<?php echo base_url(); ?>/assets/documents/kelas6/MTK/bulat.docx">Matematika</a></button>
                        <button type="button" class="btn btn-outline-secondary"><a href="<?php echo base_url(); ?>/assets/documents/kelas6/IPA/kembangbiak.pdf">Ilmu Pengetahuan Alam</a></button>
                  ...
                  <div class="card">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                      <div class="card-body">
                        ...
                        <button type="button" class="btn btn-outline-secondary video-btn" data-toggle="model"><a href="<?php echo base_url(); ?>/assets/videos/kelas6/Nabi.MP4">Agama</a></button>
