        ...
        <div class="col-md-12">
          ...
          <main role="main">
            <section class="jumbotron text-center">
              <div class="container">
                <h1 class="jumbotron-heading">Kelas 4</h1>
                <p class="lead text-muted">Pada tingkat Kelas 4, Materi yang dapat diakses meliputi Matematika, Agama Islam, serta video-video pelajaran setiap materi.</p>
              </div>
            </section>
           </main>
           <div class="row">
               ...
               <div class="accordion" id="accordionExample">
                  <div class="card">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                      <div class="card-body">
                        <button type="button" class="btn btn-outline-secondary"><a href="<?php echo base_url(); ?>/assets/documents/kelas4/Agama/Alquran.pdf">Agama Islam</a></button>
