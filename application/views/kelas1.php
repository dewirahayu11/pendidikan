      ...
      <div class="container">
        <<div class="row py-5">
          <div class="col-md-12 py-5">
           <h3 class="text-center m-2"><br> KELAS 1 </br> <br></br>"Pada tingkat Kelas 1, Materi yang dapat diakses meliputi Matematika, Bahasa Indonesia, Agama Islam, serta video-video pelajaran setiap materi</h3>
         </div>
        </div>
      </div>
    </div>
                  ...
                  <div class="card">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                      <div class="card-body">
                        ...
                        <button type="button" class="btn btn-outline-secondary"><a href="<?php echo base_url(); ?>/assets/documents/kelas1/agama.pdf">Agama Islam</a></button>
                  ...
                  <div class="card">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                      <div class="card-body">
                        ...
                        <button type="button" class="btn btn-outline-secondary video-btn" data-toggle="model"><a href="<?php echo base_url(); ?>/assets/videos/kelas1/Agama.MP4">Agama Islam</a></button>
                      </div>
                    </div>
                  </div>
                </div>
