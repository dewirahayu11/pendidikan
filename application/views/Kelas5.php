      ...
      <div class="container">
        <<div class="row py-5">
          <div class="col-md-12 py-5">
           <h3 class="text-center m-2"><br> KELAS 5 </br> <br></br>"Pada tingkat Kelas 5, Materi yang dapat diakses meliputi Matematika, Bahasa Indonesia, Ilmu Pengetahuan Alam, Agama Islam, serta video-video pelajaran setiap materi.</h3>
         </div>
        </div>
      </div>
    </div>
                  ...
                  <div class="card">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                      <div class="card-body">
                        ...
                        <button type="button" class="btn btn-outline-secondary"><a href="<?php echo base_url(); ?>/assets/documents/kelas1/kelas 1 agama islam.pdf">Ilmu Pengetahuan Alam</a></button>
                  ...
                  <div class="card">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                      <div class="card-body">
                        ...
                        <button type="button" class="btn btn-outline-secondary video-btn" data-toggle="model"><a href="<?php echo base_url(); ?>/assets/videos/kelas5/RUKUN.MP4">Agama Islam</a></button>
                        <button type="button" class="btn btn-outline-secondary video-btn" data-toggle="model"><a href="<?php echo base_url(); ?>/assets/videos/kelas5/Vokal.MP4">Bahasa</a></button>
                      </div>
                    </div>
                  </div>
                </div>
